...
{
    // default connection
    public static $dbname = 'ex_xcrud_db'; // Your Database name
    ...
    public static $language = 'en'; //'pt-BR'; // sets default localization
    ...
    // grid settings
    public static $show_primary_ai_field = false; // Show primary auto-increment field in create/edit views.
    public static $show_primary_ai_column = false; // Show primary auto-increment column in list views.
    ...
    public static $clickable_list_links = true; // make all links, emails clikable in list views
    public static $clickable_filenames = true; // makes filenames clikable in list views
    ...
    public static $images_in_grid = true; // shows images in list views
    public static $images_in_grid_height = 55; // maximal height of thumbnails in list views
    public static $button_labels = false; // displays button labels in grid
    public static $strip_tags = true; // remove all tags from data in grid views. This is not affected to user patterns or other custom.
    public static $safe_output = false; // encodes special characters to html-entities in grid views
