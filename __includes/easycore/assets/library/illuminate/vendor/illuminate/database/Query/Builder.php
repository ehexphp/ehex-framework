...
class Builder
{
    ...
    /**
     * Xamtax Edit for Ex Ehex Framework
     * @param $condition
     * @param mixed ...$where
     * @return $this|Builder
     */
    public function whereIf($condition = true, ...$where){
        if($condition) return $this->where(...$where);
        else return $this;
    }
    ...
    {
        $result = collect($this->onceWithColumns($columns, function () {
            return $this->processor->processSelect($this, $this->runSelect());
        }));
        return  $result; // \Object1::toArrayObject(true,  $result );
    }
     ...
     */
    public function paginateLavaralDefault($perPage = 15, $columns = ['*'], $pageName = 'page', $page = null){
    ...
    /**
     * XAMTAX Ehex EX MODIFIED
     *
     *
     * @param int $limit
     * @param bool $asInfiniteLoop
     * @param array $infiniteLoadConfig
     * @param string $paginationTemplateClass
     * @param string $pageKeyName
     * @return $this
     */
    public function paginate($limit = 10, $asInfiniteLoop = false, $infiniteLoadConfig = [], $paginationTemplateClass = \DefaultPaginationTemplate::class, $pageKeyName = 'page'){
        $result = paginate($this->limit(10), $limit, $asInfiniteLoop,$infiniteLoadConfig, "Eloquent" , [], $paginationTemplateClass, $pageKeyName);

        // quick fix for laravel, i don;t knw why records need to be called manually
        $result->records = \Object1::toArray($result->records());
        return $result;// \Object1::toArrayObject(true, $result);
    }
