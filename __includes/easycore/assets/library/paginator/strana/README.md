...
### Step 1:
Prepare your __FILE_BASE or array records:
...
If you are not using the __FILE_BASE tool whose adapter ships with Strana then you can build your own adapter with ease. Create your class which must implement `Strana\Interfaces\CollectionAdapter`.
...
class CustomAdapter implements CollectionAdapter{
    ...
    public function total()
    {
        __FILE_BASE
        //  Clone it.
        $records = clone($this->record__FILE_BASE    
