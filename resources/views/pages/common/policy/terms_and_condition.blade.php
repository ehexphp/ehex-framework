                    ...
                    <div class="card-body">
                        <div class="jumbotron clearfix">
                            ...
                            <?php
                                ...
                                $companySupportEmail = 'support@'.$siteName;
                                $companyAddress = $frontendPage->contact_address;
                            ...
                            <div id='ppBody' class="mt-4">

                                <h1><strong>{!!  Config1::APP_FANCY_TITLE !!}</strong></h1>
                                <h3>Welcome to {!!  Config1::APP_FANCY_TITLE !!}</h3>
                                <p>These terms and conditions outline the rules and regulations for the use of {!!  Config1::APP_FANCY_TITLE !!}'s Website.</p> <br />
                                <span style="text-transform: capitalize;"> {!!  Config1::APP_FANCY_TITLE !!}</span> is located at:<br />
                                <address>{!! $companyAddress !!} </address>
                                <br/>


                                <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use {!!  Config1::APP_FANCY_TITLE !!}'s website
                                ...
                                <p>We employ the use of cookies. By using {!!  Config1::APP_FANCY_TITLE !!}'s website you consent to the use of cookies
                                    in accordance with {!!  Config1::APP_FANCY_TITLE !!}'s privacy policy.</p><p>Most of the modern day interactive web sites
                                    use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
                                    to enable the functionality of this area and ease of use for those people visiting. Some of our
                                    affiliate / advertising partners may also use cookies.</p><h2>License</h2>
                                <p>Unless otherwise stated, {!!  Config1::APP_FANCY_TITLE !!} and/or it’s licensors own the intellectual property rights for
                                    all material on {!!  Config1::APP_FANCY_TITLE !!}. All intellectual property rights are reserved. You may view and/or print
                                    pages from {{ $companyName }} for your own personal use subject to restrictions set in these terms and conditions.</p>
                                <p>You must not:</p>
                                <ol>
                                ...
                                <p>Redistribute content from {!!  Config1::APP_FANCY_TITLE !!} (unless content is specifically made for redistribution).</p>
                                <h2>User Comments</h2>
                                <ol>
                                    <li>This Agreement shall begin on the date hereof.</li>
                                    <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
                                        material and data ('Comments') in areas of the website. {!!  Config1::APP_FANCY_TITLE !!} does not screen, edit, publish
                                        or review Comments prior to their appearance on the website and Comments do not reflect the views or
                                        opinions of {!!  Config1::APP_FANCY_TITLE !!}, its agents or affiliates. Comments reflect the view and opinion of the
                                        person who posts such view or opinion. To the extent permitted by applicable laws {!!  Config1::APP_FANCY_TITLE !!} shall
                                        ...
                                        website.</li>
                                    <li>{!!  Config1::APP_FANCY_TITLE !!} reserves the right to monitor all Comments and to remove any Comments which it considers
                                    ...
                                    <li>You hereby grant to <strong>{!!  Config1::APP_FANCY_TITLE !!}</strong> a non-exclusive royalty-free license to use, reproduce,
                                ...
                                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
                                    ...
                                    <a style="color:#ff7669" href="mailto:{{ $companyEmail }}" title="send an email to {{ $companyEmail }}">{{ $companyEmail }}</a>.
                                    <a style="color:#ff7669" href="mailto:{{ $companyHelpEmail }}" title="send an email to {{ $companyHelpEmail }}">{{ $companyHelpEmail }}</a>.
                                    <a style="color:#ff7669" href="mailto:{{ $companySupportEmail }}" title="send an email to {{ $companySupportEmail }}">{{ $companySupportEmail }}</a>.
                                ...
                                <p>No use of {!!  Config1::APP_FANCY_TITLE !!}'s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                                <h2>Iframes</h2>
                                ...
                                <h2>Money</h2>
                                <p>No money paid is refundable</p>

                                {{--
                                <h2>Credit & Contact Information</h2>
                                <p>This Terms and conditions page was created at
                                    <a style="color:inherit;text-decoration:none;cursor:text;" href="https://termsandconditionstemplate.com">
                                        termsandconditionstemplate.com
                                    </a> generator. If you have
