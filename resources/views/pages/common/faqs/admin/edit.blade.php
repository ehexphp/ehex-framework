                ...
                <div class="col-lg-9 col-md-12">
                    <div class="card card-small mb-3">
                        <div class="card-body">
                            ...
                            {!! HtmlForm1::addInput('Title', ['name'=>'title', 'value'=>$model->title, 'class'=>'form-control form-control-lg mb-3', 'placeholder'=>"Title"])!!}
                            {!! HtmlForm1::addTextArea('Description', ['name'=>'description', 'value'=>$model->description, 'class'=>'richeditor form-control form-control-lg mb-3', 'style'=>'width:100% !important; height:300px !important', 'placeholder'=>"Content Description"]) !!}
                        </div>
                    </div>
                    ...
                    <div class="card card-small mb-3">
                        <div class="card-body">
                            <h3>{{ $model_name }} List <span class="badge badge-warning">{{ Faqs::getActiveCount() }}</span> <a href="{{ url("/{$route_name}/create") }}" class="pull-right btn btn-outline-primary"><i class="fa fa-plus" aria-hidden="true"></i> Create New</a></h3>
                            <a name="manage"></a>
