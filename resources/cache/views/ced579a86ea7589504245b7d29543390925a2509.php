                    ...
                    <td style="text-align:center; vertical-align:top; font-size:14px; padding:40px 30px 30px 30px">
                        <div aria-labelledby="mj-column-per-100" class="x_mj-column-per-100" style="vertical-align:top; display:inline-block; font-size:13px; text-align:left; width:100%">
                            <div></div><table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width:180px">
                                                        <a href="<?php echo e(url('/')); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable">
                                                            <img data-imagetype="External" src="<?php echo e(Picture1::toBase64(path_asset('logo.png'))); ?>" alt="" title="" height="140" width="160" style="border:none; display:block; outline:none; text-decoration:none; width:160px; height:140px" />
                                                        </a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                ...
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding: 10px 10px 35px;">
                                        <div style="color: rgb(140, 140, 140); font-family: Roboto, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 16px; line-height: 25px">
                                            We just need to validate your email address to activate your <?php echo Config1::APP_FANCY_TITLE; ?> account. Simply click the following button:</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding: 10px 10px 35px;">
                                ...
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding: 10px 10px 40px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" align="center" border="0" style="border-collapse:separate">
                                            <tbody>
                                            <tr>
                                                <td align="center" valign="middle" bgcolor="#fead0d" style="border-radius:2px; color:#fff; padding:10px 25px"><a href="<?php echo e($url); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="display:inline-block; text-decoration:none; background:#fead0d; color:#fff; font-family:Roboto,Helvetica,Arial,sans-serif,Helvetica,Arial,sans-serif; font-size:14px; font-weight:normal; margin:0">Activate my account </a></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding:10px; padding-bottom:35px">
                                        <div style="color: rgb(53, 134, 255); font-family: Roboto, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 14px; line-height: 22px;">
                                            <a href="<?php echo e($url); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="text-decoration:none; color:inherit"><?php echo e($url); ?></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding:10px">
                                        <div style="color: rgb(140, 140, 140); font-family: Roboto, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 14px; line-height: 22px;">The <?php echo Config1::APP_TITLE; ?> Crew </div>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                ...
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding: 10px;">
                                        <div style="color: rgb(140, 140, 140); font-family: Roboto, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 12px; line-height: 22px;">
                                            <span>This email was sent to you by <?php echo e(Config1::APP_TITLE); ?> because you signed up for a <?php echo e(Config1::APP_TITLE); ?> account.</span>
                                ...
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding: 10px 10px 15px;">
                                        <div style="color: rgb(140, 140, 140); font-family: Roboto, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 12px; line-height: 22px;">
                                            © <?php echo e(date('Y')); ?> | <?php echo e(Config1::APP_TITLE); ?> </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding: 10px;">
                                        <div style="color: rgb(140, 140, 140); font-family: Roboto, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 12px; line-height: 22px;">
                                            <a href="<?php echo e(url('/privacy_policy')); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="color:inherit; padding:0 7px">Privacy Policy</a>
                                            <a href="<?php echo e(url('/privacy_policy')); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="color:inherit; padding:0 7px">Sending Policy</a>
                                            <a href="<?php echo e(url('/terms_and_condition')); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="color:inherit; padding:0 7px">Terms of Use</a> </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="word-break:break-word; font-size:14px; padding:10px">
                                        <div style="color: rgb(140, 140, 140); font-family: Roboto, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 12px; line-height: 22px;">
                                            ...
                                            <a href="<?php echo e($frontendPage->social_facebook); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="text-decoration:none; color:inherit; padding:0 4px"><img data-imagetype="External" src="https://app.mailjet.com/images/email/transac/fb.png" alt="" width="-22" height="auto" style="border:none; outline:none; text-decoration:none; height:auto">
                                            </a><a href="<?php echo e($frontendPage->social_twitter); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="text-decoration:none; color:inherit; padding:0 4px"><img data-imagetype="External" src="https://app.mailjet.com/images/email/transac/tw.png" alt="" width="-22" height="auto" style="border:none; outline:none; text-decoration:none; height:auto">
                                            </a><a href="<?php echo e($frontendPage->rss_feed); ?>" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="text-decoration:none; color:inherit; padding:0 4px"><img data-imagetype="External" src="https://app.mailjet.com/images/email/transac/rss.png" alt="" width="-22" height="auto" style="border:none; outline:none; text-decoration:none; height:auto"></a>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
