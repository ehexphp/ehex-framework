    ...
    <div class="main-content-container container-fluid px-4">
        ...
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle"><?php echo e($userInfo->full_name.'\'s Dashboard'); ?></span>
        ...
        <?php if($userInfo->status === 'inactive'): ?>
            <div class="row mb-2">
                <div class="col-12">
                    <div class="card card-small border-top">
                        <div class="card-body bg-danger text-white">
                            ...
                            <a href="<?php echo e(url('profile')); ?>" class="pull-right btn btn-primary btn-sm">Change email</a>
                            <a href="<?php echo e(Form1::callController("User@sendVerificationMail(".$userInfo->email.", ".$userInfo->user_name.", true)").'?token='.token()); ?>" class="mr-2 pull-right btn btn-warning btn-sm">Resend Mail</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.shards_dashboard.template', ['page_title'=>'Dashboard', 'allow_xcrud'=>true], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>